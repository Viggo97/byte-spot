...
describe('CustomOverlay', () => {
    ...
    it('should add backdrop background', () => {
        ...
        expect(backdrop).toHaveClass('overlay-backdrop-background');
    });

    it('should NOT add backdrop background', () => {
        overlay = service.show(MockComponent, { backdrop: { background: false } });
        const backdrop = document.querySelector('.overlay-backdrop');
    ...
    it('should add backdrop close action on click', () => {
        overlay = service.show(MockComponent);
        const spy = spyOn(overlay, 'close').and.callThrough();
        const backdrop = document.querySelector('.overlay-backdrop') as HTMLDivElement;
    ...
    it('should NOT add backdrop close action on click', () => {
        overlay = service.show(MockComponent, { backdrop: { closeOnBackdropClick: false } });
        const spy = spyOn(overlay, 'close').and.callThrough();
        const backdrop = document.querySelector('.overlay-backdrop') as HTMLDivElement;
    ...
    it('should add backdrop close action on Escape', () => {
        overlay = service.show(MockComponent);
        const spy = spyOn(overlay, 'close').and.callThrough();
        const escapeEvent = new KeyboardEvent('keydown', { code: Keycodes.ESCAPE });
        const backdrop = document.querySelector('.overlay-backdrop') as HTMLDivElement;
    ...
    it('should NOT add backdrop close action on Escape', () => {
        overlay = service.show(MockComponent, { backdrop: { closeOnEscape: false } });
        const spy = spyOn(overlay, 'close').and.callThrough();
    ...
    it('should set component position based on directPosition options', () => {
        overlay = service.show(MockComponent, { directPosition: { top: 10, left: 20 } });
        const overlayContent = document.querySelector('.overlay-content') as HTMLDivElement;
    ...
    it('should set component position based on relativePosition default options', () => {
        ...
        overlay = service.show(MockComponent, { relativePosition: { relativeElement } });
    ...
    it('should close overlay', () => {
        ...
        overlay.close$.subscribe(() => {
            counter += 1;
        });
        overlay.close();

        expect(overlay.componentRef).toBeTruthy();
