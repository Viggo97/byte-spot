...
@Component({
    selector: 'bsa-offers-settings-sort',
    imports: [
        FormsModule,
        SelectComponent,
    ],
    ...
    sortOptions: SortOption[] = [
        {
            ...
            label: this.translateService.translate('offers.newest'),
        },
        {
            key: OfferSort.HIGHEST_SALARY,
            label: this.translateService.translate('offers.highestSalary'),
        },
        {
            key: OfferSort.LOWEST_SALARY,
            label: this.translateService.translate('offers.lowestSalary'),
        },
    ];
